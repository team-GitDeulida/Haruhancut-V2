...
public final class HomeV3Coordinator: NSObject, Coordinator, HomeRouteTrigger {
    ...
    public func start() {
        let builder = HomeFeatureV3.HomeFeatureBuilder()
...
private extension HomeV3Coordinator {
    ...
    func presentFeedComment(
        post: Post,
        builder: HomeFeatureV3.FeedDetailBuilder,
    ...
    func showCalendarDetail(posts: [Post], selectedDate: Date) {
        let builder = HomeFeatureV3.CalendarDetailBuilder()
    ...
    func presentCalendarComment(
        post: Post,
        builder: HomeFeatureV3.CalendarDetailBuilder,
        presentingViewController: UIViewController & RefreshableViewController
    ) {
...
extension HomeV3Coordinator: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
